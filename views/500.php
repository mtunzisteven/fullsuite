...
<html lang="en-us" xmlns="http://www.w3.org/1999/xhtml" >
    ...
    gtag('config', 'UA-173492477-1');
        ...
        <meta name="title" content="<?php echo $page ?> | We Are Your Online Marketing Solution">
        ...
        <meta property="og:image" content="/mediafrikaco/images/logo.png" />
        ...
        <link href="/mediafrikaco/css/styles.css" rel="stylesheet">
    ...
    <body>
        <div class="wrapper">
        <div class="overlay">
                <div class="columns-two header-nav">
                    <?php
                        require $_SERVER['DOCUMENT_ROOT'] . "/mediafrikaco/snippets/header.php";
        
                        require $_SERVER['DOCUMENT_ROOT'] . "/mediafrikaco/snippets/navigation.php";
                    ?>
                </div>
            ...
            <!-- -- --  --  --  --  --  --  --  --  --  Section 1 Area -- -- -- -- -- -- -- -- -- -- - -- --  --  -->
            <div class="column color-gradient">
                            
                <!-- -- --  --  --  --  --  --  --  --  --  Section 1.1 Area -- -- -- -- -- -- -- -- -- -- - -- --  --  -->

                <div class="column-one package-intro">
                    <p class="color-gradient-font  font-center">If You Can Imagine It, We Can Design It For You</p>
                    <h3 class="color-gradient-font  font-center">We are digital marketing professionals</h3>         
                </div>
                <div class="notfound-image-dive">
                    <img class="not-found-image" src="" alt="">
                </div>

            </div>
         <!-- -- --  --  --  --  --  --  --  --  --  Footer -- -- -- -- -- -- -- -- -- -- - -- --  --  -->
         <?php require $_SERVER['DOCUMENT_ROOT'] . "/mediafrikaco/snippets/footer.php"; ?> 
    </body>
</html>